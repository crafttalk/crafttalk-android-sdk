...
- color_barrier_replied_message - устанавливает цвет барьера для процитированного блока в сообщении
- color_text_user_replied_message - устанавливает цвет текста процитированного сообщения
- color_user_replied_file_name - устанавливает цвет текста имени файла процитированного сообщения
- color_user_replied_file_size - устанавливает цвет текста размера файла процитированного сообщения
- size_user_replied_message - устанавливает размер текста процитированного сообщения
