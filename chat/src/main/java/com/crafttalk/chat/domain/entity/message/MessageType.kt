...
enum class MessageType(val valueType: Int) {
    ...
    USER_WAS_MERGED(25),                                                                    // Cинхронизация сообщений до и после перехода на новую авторизацию Служебное  сообщение,  обозначающее  что  было  произведено  слияние пользователя с другим пользователем
    ...
    INITIAL_MESSAGE(30),                                                                    // Cообщение, которое регулируется полем showInitialMessage
